  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-4 pb-4">
        <div className="glass-card px-5 py-3 flex items-center justify-between shadow-xl">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-semibold
                ...
                hover:bg-red-100 dark:hover:bg-red-500/[0.12] transition-colors cursor-pointer"
            >
            ...
            <button
              ...
              className="p-2 rounded-lg text-slate-400 hover:text-slate-600 dark:hover:text-slate-300
                hover:bg-slate-100 dark:hover:bg-white/[0.06] transition-colors cursor-pointer"
