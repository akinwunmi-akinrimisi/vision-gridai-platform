export default function TopicSummaryBar({ total, approved, rejected, pending }) {
  return (
    <div className="sticky top-0 z-10 glass-card px-3 sm:px-5 py-3 mb-4 flex items-center gap-3 sm:gap-6 text-xs sm:text-sm overflow-x-auto">
      <span className="font-semibold text-slate-900 dark:text-white whitespace-nowrap">{total} Topics</span>
