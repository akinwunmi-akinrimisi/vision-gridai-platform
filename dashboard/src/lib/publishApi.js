...
export const approveVideo = (topicId, action, scheduleTime) =>
  webhookCall('video/approve', { topic_id: topicId, action, schedule_time: scheduleTime });
...
export const publishVideo = (topicId) =>
  webhookCall('video/publish', { topic_id: topicId });
...
export const batchPublish = (topicIds) =>
  webhookCall('video/batch-publish', { topic_ids: topicIds });
...
export const retryUpload = (topicId) =>
  webhookCall('video/retry-upload', { topic_id: topicId });
